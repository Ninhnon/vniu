...
import {  deleteRequest,
  getRequest,
  putRequest, postRequest } from '@configs/fetch';
...
export const useCart = () => {
  ...
  const fetchUserCart = async () => {
    ...
    console.log("🚀 ~ fetchUserCart ~ userShoppingCart.data.value.items:", userShoppingCart.data.value.items)

    return userShoppingCart.data.value.items;
  };
